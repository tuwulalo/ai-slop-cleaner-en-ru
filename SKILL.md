...
9. **Длинное тире: строгий бан в выводе.** Никогда не ставь длинное тире в результате
   чистки; заменяй на запятую, точку, двоеточие, скобки или перестройку, в любом регистре.
   Это про то, что МЫ производим; детекция чужого текста остаётся регистро-зависимой.
