...
7. **Самоверификация (обязательно).** Прогони свой же детектор по СВОЕМУ выводу:
   остались хард-теллы? высокие маркеры? ровный burstiness? Если да — правь ещё.
   **Не отдавай текст, который валит собственный детектор.** Итерируй, пока не
   пройдёт, либо честно скажи, что осталось и почему (например, факты не дают сломать
   ритм). Это главное правило чистки.
